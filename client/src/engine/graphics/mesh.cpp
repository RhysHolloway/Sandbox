...
Mesh::Mesh(Engine::Shader&& shader, Engine::Texture&& textures, const std::vector<MeshVertex>& vertices, const std::vector<unsigned int>& indices) noexcept : s{shader}, t{textures} {
//        this->s
...
void Mesh::update_camera(const glm::mat4& camera) {
        s.use();
